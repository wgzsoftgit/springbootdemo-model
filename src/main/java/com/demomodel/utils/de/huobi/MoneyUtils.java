...
public class MoneyUtils {
	...
	public static void main(String[] args) {
		System.err.println(number2CNMontray("9876543210"));
		System.err.println("将人民币转换为会计格式金额(xxxx,xxxx,xxxx.xx),保留两位小数"+accountantMoney(new BigDecimal("98765432.10")));
	System.err.println(getFormatMoney(new BigDecimal("98765432.10"),2,100));
	}
    /**
     * 汉语中数字大写
     */
...
//https://blog.csdn.net/JavaWebEngineer/article/details/107332648