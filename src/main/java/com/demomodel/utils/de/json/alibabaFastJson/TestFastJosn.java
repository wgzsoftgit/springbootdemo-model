package com.demomodel.utils.de.json.alibabaFastJson;
...
public class TestFastJosn {
	...
	public static void main(String[] args) throws IOException {
		//JsonToObject();
		TestFastJosn testFastJosn=new TestFastJosn();
		//testFastJosn.JsonToObject();
		testFastJosn.parserJsonTxt();
	}
    /**
     * java对象转 json字符串
     */
   ...
   /**
    * String  => JSONObject JSONObject obj=JSONObject.parseObject(jsontext);
    * String   =>   java对象     info_util iu = JSON.parseObject(jsontext, info_util.class);
    * @throws IOException
    */
