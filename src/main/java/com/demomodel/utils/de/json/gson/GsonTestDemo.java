package com.demomodel.utils.de.json.gson;
...
//通过JsonParser对象可以把json格式的字符串解析成一个JsonElement对象   String ==> JsonElement => jsonObject and JsonArray
...
//把JsonElement对象转换成JsonObject
		...
		if (el.isJsonObject()) {
			...
			String sex = jsonObj.get("name").getAsString();
