...
/**显示几秒前，几小时前，几天前，几月前，和几年前等：
 * 
 * 自 Java 8 以来，JDK 中就又新增了一系列表示时间和日期的新类，Date 中的很多方法都已经被废除了，
 * LocalDateTime 在现如今才是最优的选择。所以传的参数是 String createTime 而不是 Date createTime。
 * 用 Date 的老项目自行修改工具类吧。
 * @author wgz
 * @date 创建时间：2020年11月26日 下午4:53:03
 */
public class TimeAgoUtils {
	...
	public static void main(String[] args) throws Exception {
		System.out.println(format("2020/11/26 16:35:35"));
	}
