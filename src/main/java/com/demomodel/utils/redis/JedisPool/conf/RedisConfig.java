...
public class RedisConfig {
    ...
    public JedisPool redisPoolFactory()  throws Exception{
      System.err.println("com.demomodel.utils.redis.JedisPool.conf.RedisConfig"+"JedisPool注入成功！！");
      System.err.println("com.demomodel.utils.redis.JedisPool.conf.RedisConfig"+"redis地址：" + host + ":" + port+password);
