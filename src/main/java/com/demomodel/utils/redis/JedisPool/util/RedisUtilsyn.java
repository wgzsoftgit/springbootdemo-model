package com.demomodel.utils.redis.JedisPool.util;
...
import com.demomodel.appListener.contextRefreshedEvent.ApplicationContextListener;
...
public class RedisUtilsyn {
	...
	protected static Logger logger = LoggerFactory.getLogger(RedisUtilsyn.class);
	...
	// 超时时间
	private static int TIMEOUT = 80000;
