package com.demomodel.es.demo.controller;
...
import com.demomodel.es.ESUtil;
import com.demomodel.es.demo.bean.ResponseBean;
import com.demomodel.es.demo.bean.User;
...
public class ESTestController {
    ...
    @RequestMapping(value = "/insert/data", method = RequestMethod.POST)//@RequestBody @RequestParam
    ...
    public ResponseBean testESFind() {
        SearchRequest searchRequest = new SearchRequest("estext");
...
//        TermQueryBuilder termQueryBuilder = QueryBuilders.termQuery("name.keyword", name);//精准查询
        PrefixQueryBuilder prefixQueryBuilder = QueryBuilders.prefixQuery("name.keyword", "s");//前缀查询
...
//        FuzzyQueryBuilder fuzzyQueryBuilder = QueryBuilders.fuzzyQuery("name", "三");//模糊查询
    ...
    public ResponseBean testESUpdate(@RequestParam String id, @RequestParam Double money) {
        UpdateRequest updateRequest = new UpdateRequest("estext", id);
