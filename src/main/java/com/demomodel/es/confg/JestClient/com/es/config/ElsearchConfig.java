package com.demomodel.es.confg.JestClient.com.es.config;
...
import com.demomodel.es.confg.JestClient.com.es.utils.SettingsAndMapping;
...
public class ElsearchConfig {
    ...
    public static <T> List<SearchResult.Hit<T, Void>> createSearch(JestClient jestClient, List<String> indexNames, List<String> indexTypes, String keyWord, T o, String... fields) {
        ...
        Search search = new Search.Builder(searchSourceBuilder.toString()).addIndices(indexNames).addTypes(indexTypes).build();
