...
public class DataSourceAop {
    ...
    public void setDataSource2test01() {
        System.err.println("com.demomodel.configure.mysqlconf.AOPmybatismysql.aop.DataSourceAop"+"test01业务");
        DataSourceType.setDataBaseType(DataBaseType.TEST01);
    }

    @Before("execution(* com.mzd.multipledatasources.service..*.test02*(..))")
    public void setDataSource2test02() {
        System.err.println("com.demomodel.configure.mysqlconf.AOPmybatismysql.aop.DataSourceAop"+"test02业务");
