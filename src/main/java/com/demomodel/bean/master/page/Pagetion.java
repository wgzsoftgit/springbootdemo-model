package com.demomodel.bean.master.page;
...
public static void main(String[] args) {
	...
	pagetion.setTotalCount(10); //总页数
	pagetion.setPageNo(2);//page
	pagetion.setPageSize(2);//pageSize
	//
	System.out.println(pagetion.getTotalPage());
System.out.println(pagetion.toString());
}
	...
	public String toString() {
		return "Pagetion [list=" + list + ", pageNo=" + pageNo + ", pageSize=" + pageSize + ", totalCount=" + totalCount
				+ ", totalPage=" + totalPage + ", begin=" + begin + "]";
	}	
